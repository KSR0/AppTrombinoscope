...
// Code is generated on: 22/02/2024 21:24:46
//
...
namespace BddpersonnelContext
{
    ...
    /// <summary>
    /// There are no comments for BddpersonnelContext.Admin in the schema.
    /// </summary>
    [Table(Name = @"bddpersonnels.admin")]
    public partial class Admin
    {
        ...
        /// </summary>
        [Column(Name = @"`password`", Storage = "_Password", CanBeNull = false, DbType = "LONGTEXT NOT NULL", UpdateCheck = UpdateCheck.Never)]
